...
public class TestSpringBootAllDemoApplication {
	...
	public static void main(String[] args) {
		SpringApplication.from(SpringBootAllDemoApplication::main).with(TestSpringBootAllDemoApplication.class).run(args);
	}
